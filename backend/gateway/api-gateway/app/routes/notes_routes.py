...
Notes route proxy — forwards /api/v1/notes/* to the notes-service.
"""
...
@router.api_route(
    ...
    operation_id="proxy_notes",
)
async def proxy_notes(request: Request, path: str):
    """Forward all /api/v1/notes/* requests to the notes-service."""
    registry = ServiceRegistry()
    target_base = registry.get_service_url("notes")
