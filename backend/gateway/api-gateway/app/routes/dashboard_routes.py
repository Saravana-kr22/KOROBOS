...
Dashboard route proxy — forwards /api/v1/dashboard/* to the dashboard-service.
"""
...
logger = logging.getLogger("api-gateway.routes.dashboard")


@router.api_route(
    "/{path:path}",
    methods=["GET", "POST", "PUT", "DELETE", "PATCH"],
    operation_id="proxy_dashboard",
)
async def proxy_dashboard(request: Request, path: str):
    """Forward all /api/v1/dashboard/* requests to the dashboard-service."""
    registry = ServiceRegistry()
    target_base = registry.get_service_url("dashboard")
