...
Analytics route proxy — forwards /api/v1/analytics/* to the analytics-service.
"""
...
logger = logging.getLogger("api-gateway.routes.analytics")


@router.api_route(
    "/{path:path}",
    methods=["GET", "POST", "PUT", "DELETE", "PATCH"],
    operation_id="proxy_analytics",
)
async def proxy_analytics(request: Request, path: str):
    """Forward all /api/v1/analytics/* requests to the analytics-service."""
    registry = ServiceRegistry()
    target_base = registry.get_service_url("analytics")
