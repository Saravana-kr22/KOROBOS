...
Test configuration for Learning Service tests.
"""
...
# Add the learning-service root to sys.path so `app.*` imports resolve
...
os.environ.setdefault("SERVICE_NAME", "learning-service-test")
